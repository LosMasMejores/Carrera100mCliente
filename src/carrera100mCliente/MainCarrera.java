...
public class MainCarrera {
	...
	static int NUM_ATLETAS = 2; // Numero de atletas por MainCarrera
	...
	public static void main(String[] args) {
		...
		Semaphore sem_salida = new Semaphore(NUM_ATLETAS);
		Semaphore sem_llegada = new Semaphore(NUM_ATLETAS);
		...
		if (respuesta.contentEquals("COMPLETO"))
			return;
		else
